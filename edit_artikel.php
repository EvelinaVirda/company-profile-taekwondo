...
<html>
        ...
        <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="submenu">
                         ...
                         <!-- Sub menu -->
                         <ul>
                            <li><a href="artikel.php">data artikel</a></li>
                        </ul>
                    </li>
                </ul>
             </div>
  ...
  <div class="col-lg-8">
            ...
            <br><br><br><br>
              ...
              $judul = stripslashes ($data['judul_artikel']); 
              $isi = stripslashes ($data['isi_artikel']); 

              ?>  
              <form id="edit_berita" method="post" action="edit_artikel_proses.php?id_artikel=<?php echo $id_artikel; ?>" enctype="multipart/form-data">
                <center><p>
                ...
                <p>
                 ...
                 <textarea name="isi_artikel" cols="50" class="ckeditor" rows="10"><?=$isi?></textarea>
                </p>
              
               <p>
                 <input type="checkbox" name="ubah_foto" value="true"> Photo Artikel <br>
                 <input type="file" name="foto">
                </p>
                
                <td colspan=2><input type="submit" name="id_artikel" id="submit" value="Kirim"></td>
