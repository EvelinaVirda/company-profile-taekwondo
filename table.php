      ...
      <div class="col-md-2">
        <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="table.php"><i class="glyphicon glyphicon-list"></i> Table Atlet</a></li>
                    ...
                    <li><a href="profil.php"></i> Ubah Password</a></li>
                </ul>
             </div>
      </div>
  <div class="col-lg-8">
...
//        query
        ...
        $reload = "table.php?pagination=true";
        ...
        <div class="panel-body">
                ...
                <a href="proses_hapus.php?nis='.$data["nis"].'"class="btn btn-danger"><span class="glyphicon glyphicon-trash"></a>
                  </td>';?>
