...
<html>
  ...
  <table cellpadding="8">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                    <input type="text" name="telp" id="telp" value="<?php echo $data['telp']; ?>" class="form-control input-md">           
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                    <input type="text" name="alamat" id="alamat" value="<?php echo $data['alamat']; ?>" class="form-control input-md">           
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                    <input type="text" name="sekolah" id="sekolah" value="<?php echo $data['sekolah']; ?>" class="form-control input-md">           
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                    <input type="text" name="sabuk" id="sabuk" value="<?php echo $data['sabuk']; ?>" class="form-control input-md">           
                    </div>
                  </div>
                  <br><br><br>
                  <tr>
                  ...
                  <hr>
                  <form id="form_prestasi" action="form_prestasi_proses.php" method="post">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="prestasi">prestasi</label>  
                    <div class="col-md-6">
                    <input type="text" name="prestasi" id="prestasi" class="form-control input-md">           
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="alamat">nis</label>  
                    <div class="col-md-6">
                    <input type="text" name="nis" id="nis" value="<?php echo $data['nis']; ?>" class="form-control input-md">           
                    </div>
                  </div>
                  <br><br>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-2">
                    <input type="text" name="tanggal" id="tanggal" class="form-control input-md" placeholder="YYYY-MM-DD">           
                    </div>
                  </div>
