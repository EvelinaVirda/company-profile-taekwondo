  ...
  <div class="col-lg-8">
            <div class="content-box-large">
              ...
              <div class="panel-options">
                <h4><a href="alamat_atlet.php" data-rel="collapse"><i class="glyphicon glyphicon-refresh"></i> Refresh</a><br>
                <a href="form_alamat.php"><span class="glyphicon glyphicon-plus"></span> Input Data</a>
              </div>
            </div>
             <?php 
...
//        query
        $query = "SELECT * FROM alamat"; // Query untuk menampilkan semua data atlet
        $sql = mysqli_query($connect, $query);
        
        //pagination config start
        $rpp = 4; // jumlah record per halaman
        $reload = "alamat_atlet.php?pagination=true";
        ...
        <div class="panel-body">
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <?php  echo '<td>
                      <a href="hapus_alamat.php?kd_alamat='.$data['kd_alamat'].'"
