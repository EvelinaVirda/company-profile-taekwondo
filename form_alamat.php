...
<html>
  ...
  <div class="col-lg-8">
            <div class="content-box-large">
              ...
              <div class="panel-title"><h1>Masukan Alamat atlet </h1></div>
              
              <div class="panel-options">
                <h4><a href="alamat_atlet.php" data-rel="collapse"><i class="glyphicon glyphicon-home"></i> Lihat Semua Alamat</a><br>
              </div>
            </div>
            <br><br><br><br>
      <form id="form_prestasi" action="form_alamat_proses.php" method="post">
